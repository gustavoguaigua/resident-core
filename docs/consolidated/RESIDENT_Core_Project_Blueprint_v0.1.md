...
Las Fases `1` de Keycloak y `2` de persistencia Tenant/Identity están en `PASS`; el
manifest queda en fase `2` y permite como siguiente incremento únicamente la Fase `3`
del runbook.
```
