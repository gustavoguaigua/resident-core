...
const gateEnvironment = {
  ...
  KEYCLOAK_ADMIN_USER: "phase6-admin",
...
try {
  ...
  run(process.execPath, [
    vitestCli,
    "run",
    "apps/api/test/tenant-lifecycle.spec.ts",
    "apps/api/test/integration/tenant-lifecycle.integration.spec.ts",
  ]);
