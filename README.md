...
Sprint 2 y lógica de negocio: no autorizados; 1 gap crítico y 2 altos abiertos
```
...
002, 007 y 025 permanecen `needs-review` y todavía no existe un contrato cerrado para
la auditoría base. El bootstrap transaccional, el contexto request-scoped de tenant
activo, Keycloak y el ownership de configuración/Prisma ya están definidos; el runbook
permanece bloqueado y no constituye un plan funcional autorizado mientras la decisión
sea `NO_GO`.
